...
public abstract class EntityProjectile extends Entity implements IProjectile {
	...
	public void t_ ()
	{
		...
		if (!this.world.isClientSide)
		{
			...
			for (int i = 0; i < list.size(); ++i)
			{
				...
				if (entity1.ad() && (entity1 != entityliving || this.ar >= 5))
				{
					...
					if (this instanceof EntityPotion && WindSpigotConfig.smoothPotting && movingobjectposition1 == null && getBoundingBox().b(entity1.getBoundingBox()))
					{
		...
		if (this.V())
		{
			...
			for (int j = 0; j < 4; ++j)
			{
				this.world.addParticle(EnumParticle.WATER_BUBBLE, this.locX - this.motX * f4, this.locY - this.motY * f4, this.locZ - this.motZ * f4, this.motX, this.motY, this.motZ, Constants.EMPTY_ARRAY);
			}
