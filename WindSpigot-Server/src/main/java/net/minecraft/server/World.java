...
public abstract class World implements IBlockAccess {
    ...
    public ExecutorService lightingExecutor = Executors.newFixedThreadPool(6, new ThreadFactoryBuilder().setNameFormat("PaperSpigot - Lighting Thread").build()); // PaperSpigot
    // -
    // Asynchronous
    // lighting
    // updates
    ...
    public boolean addEntity(Entity entity, SpawnReason spawnReason) { // Changed signature, added SpawnReason
        ...
        if (entity instanceof EntityHuman) flag = true;
