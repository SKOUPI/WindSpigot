...
public abstract class BlockFluids extends Block {
	...
	{
		if (material == Material.WATER) return Blocks.FLOWING_WATER;
		else if (material == Material.LAVA) return Blocks.FLOWING_LAVA;
		else throw new IllegalArgumentException("Invalid material");
	}

	public static BlockStationary b (Material material)
	{
		if (material == Material.WATER) return Blocks.WATER;
		else if (material == Material.LAVA) return Blocks.LAVA;
		else throw new IllegalArgumentException("Invalid material");
	}
}
