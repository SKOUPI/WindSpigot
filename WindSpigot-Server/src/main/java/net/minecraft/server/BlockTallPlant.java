...
public class BlockTallPlant extends BlockPlant implements IBlockFragilePlantElement {
	...
	public enum EnumTallFlowerVariants implements INamable {
		...
		static
		{
			...
			for (EnumTallFlowerVariants blocktallplant_enumtallflowervariants : ablocktallplant_enumtallflowervariants)
			{
				EnumTallFlowerVariants.g[blocktallplant_enumtallflowervariants.a()] = blocktallplant_enumtallflowervariants;
			}
